...
def runner(url):
    ...
    driver = webdriver.Chrome(executable_path='/home/kali/Desktop/new/scanner/new/chromedriver', chrome_options=opts)
    driver.get(url)
...
def check(url):
    ...
    hearders = {'User-Agent': '<img src=123 onerror=alert(document.domain)>','Connection': 'close'}
    try:
